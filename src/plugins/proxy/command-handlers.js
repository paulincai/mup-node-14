...
const log = debug('mupix:module:proxy');
const PROXY_CONTAINER_NAME = 'mup-nginx-proxy';

export function logs(api) {
  log('exec => mupix proxy logs');
...
export async function nginxConfig(api) {
  log('exec => mupix proxy nginx-config');
